...
![Pasted image 20241020223739|600](http://cdn.jsdelivr.net/gh/duyupeng36/images@master/obsidian/1755788324529-272c706545dc49e19cbdda10ca37110e.png)

在一个 **可读但无可执行权限的目录** 下，可列出其中的文件名，但无论文件本身的权限如何，也不能访问其内容

![Pasted image 20241020224305|600](http://cdn.jsdelivr.net/gh/duyupeng36/images@master/obsidian/1755788324529-7adab9044a6c481989e3b2da7698739e.png)

### 文件权限字符串

Unix/Linux 命令 `ls -l` 可以显示文件的类型和权限。例如

![Pasted image 20241020162152|600](http://cdn.jsdelivr.net/gh/duyupeng36/images@master/obsidian/1755788324531-8e56bc79009540d3b0da2a9d24d9202a.png)

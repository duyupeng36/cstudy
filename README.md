...
| [[Go 语言：基础语法]]  | 声明 基本类型 运算符 控制流程          |
| [[Go 语言：数组与切片]] | 数组 切片 切片的扩容机制             |
| [[Go 语言：字符串]]   | `strings` 包和 `strcov` 包   |
| [[Go 语言：map]]   | `map` 的底层实现 `map` 的使用     |
| [[Go 语言：指针]]    | 被限制的 Go 指针                |
| [[Go 语言：函数基础]]  | 函数的定义与调用 函数调用栈布局 作用域      |
| [[Go 语言：垃圾回收]]  | Go 1.3 之前：标记-清除 Go 1.5 之后 |
| [[Go 语言：函数高级]]  | 递归 高阶函数 匿名函数 闭包 defer     |
| [[Go 语言：结构体]]   | 结构体 匿名嵌入 内存对齐             |
| [[Go 语言：方法]]    | 值接收者 指针接收者 和 Bit 数组       |
...
| [[Python：运算符重载]]         | Python 的常规运算符重载                                                                            |
| [[Python：模拟容器]]          | 模拟 Python 中容器的行为                                                                           |
| [[Python：可调用对象]]         | 模拟 Python 中函数的行为                                                                           |
| [[Python：上下文管理]]         | 管理资源                                                                                       |
| [[Python：反射]]            | 获取或设置对象属性                                                                                  |
| [[Python：描述器]]           | 描述器的概念 实现 和 应用                                                                             |
| [[Python：元类]]            | 创建类的类；`__slots__` 属性修改对象的名字空间                                                              |
|                          |                                                                                            |
| **应用**                   |                                                                                            |
| [[Python：进程]]            |                                                                                            |
| [[Python：线程]]            |                                                                                            |
